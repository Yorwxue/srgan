...
"""Contains the definition of the models Resnet V1 architecture.
As described in http://arxiv.org/abs/1602.07261.
  models-v4, models-ResNet and the Impact of Residual Connections
    on Learning
...
def inception_resnet_v1(inputs, is_training=True,
    ...
    """Creates the models Resnet V1 model.
    Args:
